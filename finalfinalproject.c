...
int main()
{
    ...
    printf("\n\033[95mPlayer 1: %c\033[0m\n", 219);
    printf("\033[90mPlayer 2: %c\033[0m\n", 219);
    printf("\033[93mPlayer 3: %c\033[0m\n", 219);
    printf("\033[34;2mPlayer 4: %c\033[0m\n", 219);
    ...
    switch(mode)
    {
        case 1:
        {
            printf("\n1.single player with 1 computer\n2.single player with 2 computers\n3.single player with 3 computers\nEnter your choice:");
            scanf("%d",&choice);
            switch(choice)
            {
                case 1:
